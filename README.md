...
missed_payments — strongest predictor of lapse
premium_to_income_ratio — affordability signal
policy_tenure — longer tenure = lower lapse risk
income_bracket — low income = higher lapse risk
agent_contact — customers contacted by agents lapse less
